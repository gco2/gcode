...
(function(root, factory) {
    ...
    var $ = function(n, e, k, h, p, m, l, b, d, g, f, c) {
        c = function(a, b) {
            return new c.i(a, b);
        };
        c.i = function(a, d) {
            k.push.apply(this, a ? a.nodeType || a == n ? [a] : "" + a === a ? /</.test(a) ? ((b = e.createElement(d || "q")).innerHTML = a, b.children) : (d && c(d)[0] || e).querySelectorAll(a) : /f/.test(typeof a) ? /c/.test(e.readyState) ? a() : c(e).on("DOMContentLoaded", a) : a : k)
        };
        c.i[f = "prototype"] = (c.extend = function(a) {
            g = arguments;
            ...
            on: function(a, d) {
                a = a.split(h);
                this.map(function(c) {
                    (h[b = a[0] + (c.b$ = c.b$ || ++p)] = h[b] || []).push([d, a[1]]);
                    c["add" + m](a[0], d)
                });
                return this;
            },
            off: function(a, c) {
                ...
                f = "remove" + m;
                this.map(function(e) {
					if (b = (g = h[a[0] + e.b$]) && g.length) {
						// for (; d = g[--b];) c && c != d[0] || a[1] && a[1] != d[1] || (e[f](a[0], d[0]), g.splice(b, 1));
                        for (; d = g[--b];) {
							if (c && c != d[0] || a[1] && a[1] != d[1] || (e[f](a[0], d[0])) ) {
								g.splice(b, 1);
							};
						}
                    }
            ...
            is: function(a) {
                d = (b = this[0]) && (b.matches || b["webkit" + l] || b["moz" + l] || b["ms" + l]);
                return !!d && d.call(b, a)
            }
        });
        return c
    ...
    Tree.prototype = {
        ...
        _dispatch: function(name, id) {
            ...
            try {
                ...
                event.initCustomEvent('vtree-' + name, true, true, {
                    id: id
                });
            }
